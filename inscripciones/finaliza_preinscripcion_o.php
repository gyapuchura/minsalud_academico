...
<div class="row">
  ...
  <div class="col-md-4">
  <a href="imprime_formulario_ins_o.php?idinscripcion=<?php echo $idinscripcion_ss;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=750,height=850,scrollbars=YES,top=50,left=200'); return false;">
  <h4 class="text-info">IMPRIMIR FORMULARIO</h4></a>
  </div>
  <div class="col-md-2"></div>
  <div class="col-md-4"><a href="oferta.php"><h4 class="text-info">SALIR</h4></div> 
</div>
